 ...
 * data models, such as {@link de.kaiser.model.structure.Document} or
 * {@link de.kaiser.model.style.StyleSheet}. This package also defines the common
 * {@link de.kaiser.processor.reader.JsonReadException} for consistent error
