...
public class LayoutTableFoGenerator extends ElementFoGenerator {
    ...
    public void generate(Element element, StyleSheet styleSheet, StringBuilder builder, List<Headline> headlines, ImageResolver resolver) {
        ...
        mainGenerator.generateBlockElement(table.getElementLeft(),styleSheet,builder,headlines,resolver);
        builder.append( "</fo:table-cell>");
        builder.append("<fo:table-cell end-indent=\"0pt\" text-align=\"end\" padding=\"0pt\">");
        mainGenerator.generateBlockElement(table.getElementRight(), styleSheet, builder, headlines,resolver);
        builder.append("</fo:table-cell>");
