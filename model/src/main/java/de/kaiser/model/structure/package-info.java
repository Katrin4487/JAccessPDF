 ...
 * </li>
 * <li>
 * <b>{@link de.kaiser.model.structure.ContentArea}</b>:
 * A simple container that holds a list of block-level elements for the header, body, or footer.
 * </li>
 * <li>
 * <b>{@link de.kaiser.model.structure.Element}</b>:
 * The central interface for all **block-level elements** such as paragraphs ({@link de.kaiser.model.structure.Paragraph}),
 * headers ({@link de.kaiser.model.structure.Headline}), lists ({@link de.kaiser.model.structure.SimpleList}), or
 * tables ({@link de.kaiser.model.structure.Table}).
 * </li>
 * <li>
 * <b>{@link de.kaiser.model.structure.InlineElement}</b>:
 * A specialized interface for all **inline elements** that can appear within a block element
 * (e.g. in a paragraph). Examples are simple text ({@link de.kaiser.model.structure.TextRun}),
 * links ({@link de.kaiser.model.structure.Hyperlink}), or footnotes ({@link de.kaiser.model.structure.Footnote}).
 * </li>
 * </ol>
 *
