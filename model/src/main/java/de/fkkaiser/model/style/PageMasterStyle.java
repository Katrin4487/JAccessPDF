...
public class PageMasterStyle {
     ...
     */
    @JsonProperty(JsonPropertyName.PAGE_HEIGHT)
     ...
     */
    @JsonProperty(JsonPropertyName.PAGE_WIDTH)
     ...
     */
    @JsonProperty(JsonPropertyName.MARGIN)
     ...
     */
    @JsonProperty(JsonPropertyName.MARGIN_TOP)
     ...
     * The value must include a unit (e.g., "1cm", "0.5in").
     */
    @JsonProperty(JsonPropertyName.MARGIN_BOTTOM)
     ...
     * The value must include a unit (e.g., "1cm", "0.5in").
     */
    @JsonProperty(JsonPropertyName.MARGIN_LEFT)
     ...
     * The value must include a unit (e.g., "1cm", "0.5in").
     */
    @JsonProperty(JsonPropertyName.MARGIN_RIGHT)
     ...
     * Default is true.
     */
    @JsonProperty(JsonPropertyName.AUTO_ADJUST_MARGINS)
     ...
     */
    @JsonProperty(JsonPropertyName.HEADER_EXTENT)
     ...
     * The value must include a unit (e.g., "2cm", "1in").
     */
    @JsonProperty(JsonPropertyName.FOOTER_EXTENT)
     ...
     */
    @JsonProperty(JsonPropertyName.COLUMN_COUNT)
     ...
     */
    @JsonProperty(JsonPropertyName.COLUMN_GAP)
    ...
    public PageMasterStyle(String name, String pageHeight, String pageWidth,
        ...
        this.name = name;
        this.pageHeight = validatedDimension(pageHeight,JsonPropertyName.PAGE_HEIGHT);
        this.pageWidth = validatedDimension(pageWidth,JsonPropertyName.PAGE_WIDTH);
        this.marginTop = validatedDimension(marginTop,JsonPropertyName.MARGIN_TOP);
        this.marginBottom = validatedDimension(marginBottom,JsonPropertyName.MARGIN_BOTTOM);
        this.marginLeft = validatedDimension(marginLeft,JsonPropertyName.MARGIN_LEFT);
        this.marginRight = validatedDimension(marginRight,JsonPropertyName.MARGIN_RIGHT);
        this.headerExtent = validatedDimension(headerExtent,JsonPropertyName.HEADER_EXTENT);
        this.footerExtent = validatedDimension(footerExtent,JsonPropertyName.FOOTER_EXTENT);
        this.columnCount = columnCount;
        this.columnGap = validatedDimension(columnGap,JsonPropertyName.COLUMN_GAP);
    ...
    public void setMargin(String margin) {
        this.margin = validatedDimension(margin,JsonPropertyName.MARGIN);
    ...
    public void validate() {
        ...
        validatedDimension(pageHeight,JsonPropertyName.PAGE_HEIGHT);
        validatedDimension(pageWidth,JsonPropertyName.PAGE_WIDTH);
        validatedDimension(marginTop,JsonPropertyName.MARGIN_TOP);
        validatedDimension(marginBottom,JsonPropertyName.MARGIN_BOTTOM);
        validatedDimension(headerExtent,JsonPropertyName.HEADER_EXTENT);
        validatedDimension(footerExtent,JsonPropertyName.FOOTER_EXTENT);
        validatedDimension(columnGap,JsonPropertyName.COLUMN_GAP);
        validatedDimension(margin,JsonPropertyName.MARGIN);
        validatedDimension(marginLeft,JsonPropertyName.MARGIN_LEFT);
        validatedDimension(marginRight,JsonPropertyName.MARGIN_RIGHT);
